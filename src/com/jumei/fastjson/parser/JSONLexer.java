...
import static com.jumei.fastjson.parser.JSONToken.COLON;
import static com.jumei.fastjson.parser.JSONToken.COMMA;
...
import static com.jumei.fastjson.parser.JSONToken.LPAREN;
import static com.jumei.fastjson.parser.JSONToken.RBRACE;
import static com.jumei.fastjson.parser.JSONToken.RBRACKET;
import static com.jumei.fastjson.parser.JSONToken.RPAREN;
...
public final class JSONLexer
{
	...
	private static boolean						V6;											// android
																								// 6
	static
	{
		int version = -1;
	...
	public final String scanSymbol(final SymbolTable symbolTable)
	{
		...
		if (ch == ']' && isEnabled(Feature.IgnoreEmptyBracket))
		{
			next();
			token = JSONToken.RBRACKET;
			return null;
	...
	{
		// final int INT_MULTMIN_RADIX_TEN = -214748364; // Integer.MIN_VALUE /
		// 10;
		// final int INT_N_MULTMAX_RADIX_TEN = -214748364; // -Integer.MAX_VALUE
		// / 10;
		...
		final int multmin = -214748364; // negative ? INT_MULTMIN_RADIX_TEN :
										// INT_N_MULTMAX_RADIX_TEN;
		if (i < max)
		{
			digit = digits[charAt(i++)];
			result = -digit;
	...
	public boolean scanISO8601DateIfMatch(boolean strict)
	{
		...
		else
		{
			...
			{// UTC
				...
				{
					String[] timeZoneIDs = TimeZone.getAvailableIDs(0);// 没有+ 和
																		// -
																		// 默认相对0
	 ...
	 * must not contain illegal characters within
	 ...
	 * formatted. The method is about twice as fast
