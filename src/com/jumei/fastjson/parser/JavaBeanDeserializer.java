...
import com.jumei.fastjson.parser.deserializer.ExtraProcessable;
...
public class JavaBeanDeserializer implements ObjectDeserializer
{
	...
	private <T> T deserialze(DefaultJSONParser parser, Type type, Object fieldName, Object object)
	{
		...
		try
		{
			...
			{
				if (lexer.isBlankInput() || token == JSONToken.LBRACKET && lexer.isEnabled(Feature.IgnoreEmptyBracket))
				{
					return null;
				}
