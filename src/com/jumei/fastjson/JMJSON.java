...
import com.jumei.fastjson.parser.ParserConfig;
...
import com.jumei.fastjson.parser.deserializer.ParseProcess;
import com.jumei.fastjson.serializer.AfterFilter;
import com.jumei.fastjson.serializer.BeforeFilter;
import com.jumei.fastjson.serializer.JSONSerializer;
import com.jumei.fastjson.serializer.NameFilter;
import com.jumei.fastjson.serializer.PropertyFilter;
import com.jumei.fastjson.serializer.PropertyPreFilter;
import com.jumei.fastjson.serializer.SerializeConfig;
import com.jumei.fastjson.serializer.SerializeFilter;
import com.jumei.fastjson.serializer.SerializeWriter;
import com.jumei.fastjson.serializer.SerializerFeature;
import com.jumei.fastjson.serializer.ValueFilter;
...
public abstract class JMJSON implements JSONStreamAware, JSONAware
{
	...
	@SuppressWarnings("unchecked")
	public static final <T> T parseObject(String input, Type clazz, ParserConfig config, ParseProcess processor, int featureValues,
			Feature... features)
	{
		if (input == null)
		{
			...
			SerializerFeature... features)
	{
		...
		{
			JSONSerializer serializer = new JSONSerializer(out, config);
			for (com.jumei.fastjson.serializer.SerializerFeature feature : features)
			{
