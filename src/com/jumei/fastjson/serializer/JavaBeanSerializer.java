	...
	public void write(JSONSerializer serializer, Object object, Object fieldName, Type fieldType) throws IOException
	{
		...
		try
		{
			...
			isWriteClassName = (features & SerializerFeature.WriteClassName.mask) != 0 //
					...
					&& (fieldType != null || (out.features & SerializerFeature.NotWriteRootClassName.mask) == 0 || serializer.context.parent != null));
			...
			for (int i = 0; i < getters.length; ++i)
			{
				...
				{
					if ((!fieldSerializer.writeNull) && (out.features & SerializerFeature.WriteMapNullValue.mask) == 0)
					{
						continue;
					}
				}
				...
				if (propertyValueGot && propertyValue != null && notWriteDefaultValue)
				{
					...
					|| fieldClass == double.class //
							...
							&& propertyValue instanceof Number && ((Number) propertyValue).byteValue() == 0)
					{
						continue;
					}
					else if (fieldClass == boolean.class //
				...
				else
				{
					if (!writeAsArray)
					{
						...
						{
							// out.write(fieldInfo.name_chars, 0,
							// fieldInfo.name_chars.length);
							{
			...
			// JSONSerializer.writeAfter(serializer, object, commaFlag ? ',' :
			// '\0');
